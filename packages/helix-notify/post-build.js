...
const packageName = packageJson.name; // "helix-notify"
const folderName = packageName.replace('helix-', ''); // "notify"
...
const version = process.env.VITE_NOTIFY_VERSION || packageJson.version;
