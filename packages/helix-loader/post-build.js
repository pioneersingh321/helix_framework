...
const packageName = packageJson.name; // "helix-loader"
const folderName = packageName.replace('helix-', ''); // "loader"
...
const version = process.env.VITE_LOADER_VERSION || packageJson.version;
