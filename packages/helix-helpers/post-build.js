...
const packageName = packageJson.name; // "helix-helpers"
const folderName = packageName.replace('helix-', ''); // "helpers"
...
const version = process.env.VITE_HELPERS_VERSION || packageJson.version;
