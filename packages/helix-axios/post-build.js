...
const packageName = packageJson.name; // "helix-axios"
const folderName = packageName.replace('helix-', ''); // "axios"
...
const version = process.env.VITE_AXIOS_VERSION || packageJson.version;
