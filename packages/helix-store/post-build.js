...
const packageName = packageJson.name; // "helix-store"
const folderName = packageName.replace('helix-', ''); // "store"
...
const version = process.env.VITE_STORE_VERSION || packageJson.version;
