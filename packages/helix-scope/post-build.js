...
const packageName = packageJson.name; // "helix-scope"
const folderName = packageName.replace('helix-', ''); // "scope"
...
const version = process.env.VITE_SCOPE_VERSION || packageJson.version;
