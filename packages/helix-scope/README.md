...
- **Expression-based Defaults**: Support `<div hx-scope:user="loadUser()" hx-scope-default:user="store.defaultUser"></div>` for dynamic default values.
...
- **Multiple Scopes**: Bind multiple scopes on the same element (`hx-scope:user="..." hx-scope:posts="..."`).
