...
const packageName = packageJson.name; // "helix-fetch"
const folderName = packageName.replace('helix-', ''); // "fetch"
...
const version = process.env.VITE_FETCH_VERSION || packageJson.version;
