...
const packageName = packageJson.name; // "helix-tooltip"
const folderName = packageName.replace('helix-', ''); // "tooltip"
...
const version = process.env.VITE_TOOLTIP_VERSION || packageJson.version;
...
async function handleTooltipCopy() {
