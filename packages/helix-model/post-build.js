...
const packageName = packageJson.name; // "helix-model"
const folderName = packageName.replace('helix-', ''); // "model"
...
const version = process.env.VITE_MODEL_VERSION || packageJson.version;
