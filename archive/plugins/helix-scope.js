this.HelixScopePlugin = function () {
        ...
        return {
            mounted(el, binding) {
                ...
                for (const child of children) {
                    ...
                    bindNode(child, childCtx, instance, []);
                }
    ...
    const scopeDirectiveDefinition = createScopeDirective();
    const HelixScopePlugin = {
        name: "scope",
        version: "2.0.2",
        install(app, options = {}) {
            app.directive("scope", scopeDirectiveDefinition);
            const root2 = typeof window !== "undefined" ? window : globalThis;
            if (root2.Helix) {
    ...
    if (root.Helix) {
        if (typeof root.Helix.directive === "function") {
            root.Helix.directive("scope", scopeDirectiveDefinition);
        }
